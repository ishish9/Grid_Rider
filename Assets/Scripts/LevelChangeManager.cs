...
public class LevelChangeManager : MonoBehaviour
{
    ...
    [SerializeField] private bool LaserSharp;
        ...
        switch (score)
        {
            case 10:
                ...
                if(LaserSharp)
                {
                    ...
                    LaserGrid_Mover.ForwardSpeed = 4.5f;
                }
                else
                {
            ...
            case 20:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 4.7f;
                }
                else
                {
            ...
            case 30:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 5;
                }
                else
                {
            ...
            case 40:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 5.2f;
                }
                else
                {
            ...
            case 50:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 5.5f;
                }
                else
                {
            ...
            case 60:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 5.7f;
                }
                else
                {
            ...
            case 70:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 6;
                }
                else
                {
            ...
            case 90:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 7;
                }
                else
                {
            ...
            case 100:
                ...
                {
                    LaserGridSpawner.SpawnSpeed = 4;
                    LaserGrid_Mover.ForwardSpeed = 8;
                }
                else
                {
